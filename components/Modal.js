                  ...
                  <div className='mt-7 flex space-x-3 w-full'>
                    ...
                    <div className='flex-grow mt-2'>
                      ...
                      <div className='flex items-center justify-between pt-2.5'>
                        ...
                        <button
                          className='bg-[#7f1e50] text-white rounded-full px-4 py-1.5 font-bold shadow-md hover:bg-[#a12766] disabled:hover:bg-[#47112d] disabled:opacity-50 disabled:cursor-default'
                          type='submit'
                          onClick={sendComment}
